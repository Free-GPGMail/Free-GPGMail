...
@interface GPGEncryptedDataPacket : GPGIgnoredPacket
@end

@interface GPGMarkerPacket : GPGIgnoredPacket
@end

@interface GPGTrustPacket : GPGIgnoredPacket
@end

@interface GPGEncryptedProtectedDataPacket : GPGIgnoredPacket
@end
