...
{
    id <MFEWSGetNewMessageActionsOperationDelegate> _delegate;	// 24 = 0x18
    long long _previousActionID;	// 32 = 0x20
}
...
- (void).cxx_destruct;	// IMP=0x0000000000096eb1
- (void)main;	// IMP=0x0000000000096cb6
- (id)initWithPreviousActionID:(long long)arg1;	// IMP=0x0000000000096c74
