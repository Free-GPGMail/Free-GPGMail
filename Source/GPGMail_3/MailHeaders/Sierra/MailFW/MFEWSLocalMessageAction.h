...
@interface MFEWSLocalMessageAction : NSObject
{
    ...
    NSArray *_missedMessages;	// 48 = 0x30
}

+ (id)log;	// IMP=0x00000000000a0825
...
- (void).cxx_destruct;	// IMP=0x00000000000a0abc
- (id)init;	// IMP=0x00000000000a0948
- (id)initWithMessageActionID:(long long)arg1 activityType:(id)arg2 mailbox:(id)arg3 userInitiated:(BOOL)arg4;	// IMP=0x00000000000a0884
