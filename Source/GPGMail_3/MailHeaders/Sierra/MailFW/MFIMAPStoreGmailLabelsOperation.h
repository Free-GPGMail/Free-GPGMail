...
- (id)description;	// IMP=0x00000000000fe33c
@property(readonly, copy, nonatomic) NSArray *gmailLabelsToClear;
@property(readonly, copy, nonatomic) NSArray *gmailLabelsToSet;
- (unsigned char)operationType;	// IMP=0x00000000000fe30d
- (id)initWithGmailLabelsToSet:(id)arg1 gmailLabelsToClear:(id)arg2 forUids:(id)arg3 inMailbox:(id)arg4;	// IMP=0x00000000000fe280
