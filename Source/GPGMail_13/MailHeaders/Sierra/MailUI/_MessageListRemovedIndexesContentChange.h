...
- (void).cxx_destruct;	// IMP=0x00000001001fe1d5
@property(readonly, copy) NSString *description;
- (unsigned long long)shiftIndex:(unsigned long long)arg1;	// IMP=0x00000001001fe095
- (void)applyToTableView:(id)arg1;	// IMP=0x00000001001fe011
- (id)init;	// IMP=0x00000001001fdf42
- (id)initWithIndexes:(id)arg1 animationOptions:(unsigned long long)arg2;	// IMP=0x00000001001fdeb5
