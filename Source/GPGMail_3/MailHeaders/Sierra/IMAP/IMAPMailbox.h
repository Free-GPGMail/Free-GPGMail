...
+ (BOOL)automaticallyNotifiesObserversOfQuotaUsage;	// IMP=0x00000000000317fd
+ (BOOL)automaticallyNotifiesObserversOfAllegedHighestModificationSequence;	// IMP=0x000000000003158f
+ (BOOL)automaticallyNotifiesObserversOfExists;	// IMP=0x00000000000314f0
...
- (id)description;	// IMP=0x0000000000031ae5
- (void)updateWithStatusEntries:(id)arg1;	// IMP=0x000000000003190f
@property(nonatomic) unsigned int permanentFlags;
- (void)setTotalSize:(unsigned long long)arg1 forQuotaMessageCount:(long long)arg2;	// IMP=0x0000000000031805
...
- (void)setExists:(unsigned long long)arg1 fromIDLE:(BOOL)arg2;	// IMP=0x0000000000031465
- (void)clearDelegate:(id)arg1;	// IMP=0x00000000000313dd
- (void)setDelegate:(id)arg1;	// IMP=0x0000000000031375
- (id)init;	// IMP=0x0000000000031361
- (id)initWithMailboxName:(id)arg1;	// IMP=0x00000000000312a4
