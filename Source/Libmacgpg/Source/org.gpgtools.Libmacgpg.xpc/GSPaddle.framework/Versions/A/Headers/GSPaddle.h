...
//! Project version number for GSPaddle.
FOUNDATION_EXPORT double GSPaddleVersionNumber;

//! Project version string for GSPaddle.
FOUNDATION_EXPORT const unsigned char GSPaddleVersionString[];
