...
- (id)_mf_objectForKey:(id)arg1 version:(unsigned long long)arg2;	// IMP=0x000000000005fb64
- (void)setDisplayName:(id)arg1 forFlagColor:(BOOL)arg2;	// IMP=0x000000000005f954
- (id)displayNameForFlagColor:(BOOL)arg1;	// IMP=0x000000000005f78b
